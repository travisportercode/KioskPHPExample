...
// Models of data tables in MySQL (usually outside of this project used by others accessing the table.
// Here we're loading in all the php classes that match database tables. 
// Just get all that are found in the directory.
// Must go before session_start().
...
// user login information for MySQL database. Should be outside of project.
$_SESSION['data']['db'] = 'MySQL_database';
$_SESSION['data']['user'] = 'MySQL_username'; 
$_SESSION['data']['pass'] = 'MySQL_password';


// optional date parameter is passed in as part of url - used for testing past or future dates; 
...
// kiosk must be passed into as part of the url on the first call. 
//  This is used for tracking the kiosk activity. 
// if passed in, the session variable is used.
// On subsequent calls of the same script, the session variable is used. 
if (!empty($_REQUEST['kiosk'])){
    $_SESSION['kiosk'] = $_REQUEST['kiosk'];
} 
// same logic for the client variable.
...
//    exit();
    ...
    if (empty($_REQUEST['error'])){
        ...
        $_SESSION['request']->updateApiCommunication("receipt:" . $_SESSION['fglReceipt']);
        
        
        
        
        authorizePaymentTriPOS($_SESSION['transactionId'], $_SESSION['amount'], $_SESSION['cardLogo']);
    } else {
...
function authorizePaymentTriPOS($transId, $amount, $ccType){
//    echo "<pre>";
//    print_r($_REQUEST);
//    echo "</pre>";
//    exit("here");
...
//            $data['ccType'] = '34';
//            $_SESSION['card'] = 'VISA';
//        } else if ($startWith >= '50' && $startWith <= '55') {   
//            $data['ccType'] = '35';
//            $_SESSION['card'] = 'MASTERCARD';
//        } else if ($startWith == '34' || $startWith == '37') {   
//            $data['ccType'] = '36';
//            $_SESSION['card'] = 'AMERICAN EXPRESS';
//        } else if ($startWith == '60' || $startWith == '65') {  
//            $data['ccType'] = '37';
//            $_SESSION['card'] = 'DISCOVER';
//        } else {
...
//    
        ...
        if (empty($oneTicket['priceZoneTime'])){$oneTicket['priceZoneTime'] = '';}
...
//            exit("login as anonymous user");
            ...
            loginUsingEmail('kiosk@justarrive.com');
            $_SESSION['logInMethod'] = 'loginUsingEmail';
            $_SESSION['loginEmail'] = 'kiosk@justarrive.com';
            $_SESSION['suppressMembershipPricing'] = true;
            $_SESSION['constituentId'] = '209843';
        }  
    }
...
//        
//        $found = false;
//        foreach ($paymentObject->PaymentMethod as $onePaymentMethod){
//            if (strpos(strtolower($onePaymentMethod->description), $_SESSION['card']) > 0){
//                $data['ccType'] = $onePaymentMethod->id;
//                $_SESSION['card'] = strtoupper($_SESSION['card']);
//                $found = true;
//            }
//        }
//        if ($found == false){
//            displayCart("Card type not found.<br>Your card was not charged.<br>Please try a different card or the same one again.");
//        }
