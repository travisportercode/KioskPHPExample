...
if (strpos($environmentUrl,"GetPerformancesTest") > 1){
    ...
    $_SESSION['salesCacheFile'] = '/ECommerceSessions/15864/PerformancesTest_' . date('Ymd') . '.txt';
    $_SESSION['logFile'] = '/ECommerceSessions/15864/logPerformancesTest_' . date('Ymd') . '.txt';
} else {
    $_SESSION['soapUrl'] = 'http://tessappprod.mfa.org/TessituraWebAPI/Tessitura.asmx?WSDL';
    $_SESSION['soapUrlDirect'] = 'http://tessappprod.mfa.org/TessituraWebAPI/Tessitura.asmx';
    $_SESSION['salesCacheFile'] = '/ECommerceSessions/15864/PerformancesProd_' . date('Ymd') . '.txt';
    $_SESSION['logFile'] = '/ECommerceSessions/15864/logPerformancesProd_' . date('Ymd') . '.txt';
}
