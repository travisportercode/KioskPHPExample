...
//            break;
        ...
        case "Space":    
            ...
            break;
        case "#+=":   
            controlFocused.value += str.substring(key,-2);
            break;
        default: 
            controlFocused.value += key;
    }
...
document.write('</tr>'); 
document.write('<tr>');
document.write('<td style="background:#636363" ' + buttonCode + '>Delete</td>'); 
document.write('<td ' + buttonCode + '>1</td>');
document.write('<td ' + buttonCode + '>2</td>');
document.write('<td ' + buttonCode + '>3</td>');
document.write('<td style="background:#dd2435" ' + buttonCode + '>Done</td>');
document.write('</tr>'); 
document.write('<tr>');
...
document.write('</tr>'); 
document.write('<tr>'); 
document.write('<td style="background:#636363" ' + buttonCode + '>#+=</td>'); 
...
document.write('</tr>'); 
document.write('<tr>'); 
document.write('<td style="background:#636363" ' + buttonCode + '>ABC</td>'); 
...
document.write('<td ' + buttonCode + '>.</td>');  
document.write('<td ' + buttonCode + '>@</td>');  
document.write('<td style="background:#636363" ' + buttonCode + '>Next</td>');  
document.write('</tr>'); 
document.write('<tr>'); 
document.write('<td colspan=1></td>'); 
document.write('<td colspan=10 style="width:900px;background:#636363" ' + buttonCode + '>Space</td>'); 
document.write('<td style="background:#dd2435" onclick="jaHideKeyboard()" ' + buttonCode + '>Done</td>'); 
document.write('</tr>'); 
document.write('</table>');             
document.write('</center>');     
document.write('</div>');      
