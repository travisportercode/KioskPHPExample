...
if (strpos($environmentUrl,"GetPerformancesTestChansouda") > 1){
    ...
    $_SESSION['salesCacheFile'] = '/ECommerceSessions/15864/PerformancesTestSalesCache_' . date('Ymd') . '.txt';
    $_SESSION['logFile'] = '/ECommerceSessions/15864/logPerformancesTestSalesCache_' . date('Ymd') . '.txt';
} else {
    $_SESSION['soapUrl'] = 'http://tessappprod.mfa.org/TessituraWebAPI/Tessitura.asmx?WSDL';
    $_SESSION['soapUrlDirect'] = 'http://tessappprod.mfa.org/TessituraWebAPI/Tessitura.asmx';
    $_SESSION['salesCacheFile'] = '/ECommerceSessions/15864/PerformancesProdSalesCache_' . date('Ymd') . '.txt';
    $_SESSION['logFile'] = '/ECommerceSessions/15864/logPerformancesProdSalesCache_' . date('Ymd') . '.txt';
}
...
//@sessionkey=KR2QUTLCMURM5BYD91Y2U47UJQRVJR2BUN36M3OF02EVNWIW2SHVWIIEI3T3Q174&@Mstart_date_range=10/05/2016&@Mend_date_range=11/01/2017&@Mmos=3&@Mbu=1
function getPerformancesChansouda($data){
    $ch = curl_init(); 
